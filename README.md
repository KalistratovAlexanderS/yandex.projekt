...
Задача: Подготовка и построение Дашборд (https://public.tableau.com/app/profile/as7053/viz/Book1_as_15_13/Dashboard1?publish=yes)
```
Выполнено: при помощи дата-пайплайны, скриптов, агрегирующих таблицы и Tableau Public.
Подгтовлен дашборд  и прзенатция для  менеджера продкукта.  Знакомство м инструментом  Redash.
```
